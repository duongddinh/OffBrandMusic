...
void search_button_clicked(GtkWidget *wid,gpointer data) {
    ...
    gtk_button_set_label(GTK_BUTTON(showLyricBtn), temp->Song);
    temp = temp->next;                 // Move to next node
    gtk_button_set_label(GTK_BUTTON(showLyricBtn1), temp->Song);
    temp = temp->next;                 // Move to next node
    gtk_button_set_label(GTK_BUTTON(showLyricBtn2), temp->Song);
    temp = temp->next;                 // Move to next node
